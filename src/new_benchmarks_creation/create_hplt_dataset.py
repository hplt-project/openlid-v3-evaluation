...
languages = {
      "bos_Latn": [0, 1], "srp_Cyrl": [0], "hrv_Latn": [0, 1], "spa_Latn": [0, 1], "cmn_Hans": [0], "cat_Latn": [0], "ast_Latn": [0], "jpn_Jpan": [0],
     "hin_Deva": [0], "fin_Latn": [2, 3], "ita_Latn": [0], "glg_Latn": [0], "slk_Latn": [1], "yor_Latn": [0], "fra_Latn": [0], "por_Latn": [0],
